...
$(document).ready(function (){
    ...
    $("#submit_button").click(function() {
        ...
        console.log("Saving 'submit_data' to local storage:");
        console.log(state)

            // Submit
            localStorage.setItem(submit_data, JSON.stringify(state));
    ...
    $("#ok_button").click(function(){
        util.scrollTo("problem_container");
    })

    $("#maintenance_menu").click(function () {
        window.location.href = "maintenance_menu.html?companyID=" + companyID;
    });
});
